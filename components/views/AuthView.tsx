  ...
  const renderRegisterForm = () => (
    <form onSubmit={handleAuthAction} className="space-y-5">
        ...
        <div className="pt-2 flex justify-between items-center space-x-2">
            ...
            {step < 3 && <button type="button" onClick={nextStep} disabled={isSubmitting} className={`w-full font-bold py-3 px-4 rounded-lg text-white ${getThemeClasses('bg')} ${getThemeClasses('hover-bg')}`}>{t('next_button')}</button>}
            {step === 3 && (
